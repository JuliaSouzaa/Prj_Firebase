        ...
        Row(
            ...
            Button(onClick = {
                ...
                db.collection("Clientes").document("PrimeiroCliente")
                    .set(city)
                    .addOnSuccessListener { Log.d(ContentValues.TAG, "DocumentSnapshot successfully writter!" )}
                    .addOnFailureListener { e -> Log.w(ContentValues.TAG, "Error writing document", )}
            }) {
                Text(text = "Cadastrar")
            }
        }
